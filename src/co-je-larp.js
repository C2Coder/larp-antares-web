  ...
  <main class="pt-16">
    ...
    <section class="py-16 bg-background-dark">
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <!-- Example story card -->
        <div class="bg-background-light rounded-2xl border border-border p-6 md:p-8">
    ...
    <section class="py-16 bg-background-light">
      <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col gap-4 text-lg text-text-muted leading-relaxed mb-10 max-w-3xl mx-auto">
          <p>
            ...
            (<a href="/jak-na-larp#kostym" class="font-semibold text-button-primary hover:underline">více ZDE</a>).
